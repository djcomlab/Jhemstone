/**
 * Linpack packaged for Java ME Jhemstone Benchmark suite
 *  - Adapted from original source of Linpack for Java from:
 *    http://www.netlib.org/benchmark/linpackjava/
 *    Ported to Java by R. Wade; Copyright (C) 1996, Reed Wade
 *    Optimized by J. Hardwick; Copyright (C) 1996, Jonathan Hardwick
 *    Modified by P. McMahan; Copyright (C) 1997, Paul McMahan
 *    Modified by D.M. Doolin; Copyright (C) 1997, David M. Doolin
 *    All rights reserved.
 *
...
public class Linpack {
    ...
    public double get_mflops_result() {
        return mflops_result;
    }
    
    public double get_residn_result() {
        return residn_result;
    }
    
    public double get_time_result() {
        return time_result;
    }
    
    public double get_eps_result() {
        return eps_result;
    }
